...
public class WeatherActivity extends AppCompatActivity {
    ...
    /**
     * 根据天气id请求城市天气信息。处理从服务器传回的数据
     */
    public void requestWeather(final String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid="+
                weatherId+"&key=3b74ba8524044d73ae8f3269c4e582cc";
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String updateTime=weather.basic.update.updateTime.split(" ")[1];//将字符串按空格分割，"1"代表取出第二个值
        ...
        Intent intent = new Intent(this, AutoUpdateService.class);//定时更新
        startService(intent);
    }
